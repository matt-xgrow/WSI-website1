...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "WSI Cleaning — Premium Exterior Cleaning Brisbane, Sunshine Coast & Gold Coast",
  ...
  twitter: {
    ...
    description: `${site.rating}/5 from ${site.reviewCount} Google reviews · ${site.insuranceLabel} · Brisbane, Gold Coast, Sunshine Coast`,
