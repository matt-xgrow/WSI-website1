...
const SERVICE_THUMB: Record<string, string> = {
  "house-washing-brisbane": "/images/house-wash.jpg",
  "pressure-cleaning-brisbane": "/images/pressure-cleaning.jpg",
  "window-cleaning-brisbane": "/images/window-clean.jpg",
    ...
    <main className="page-shell">
      ...
      <section className="sub-hero">
        <div>
          ...
          <h1>
            Exterior cleaning in <em className="hl-orange">{location.name}</em>.
          </h1>
      ...
      <section className="location-areas-grid">
        {services.map((service) => (
          <Link href={`/services/${service.slug}`} key={service.slug}>
            <Image
              src={SERVICE_THUMB[service.slug] ?? service.image}
              alt=""
              width={72}
              height={72}
            ...
            <svg viewBox="0 0 16 16" width="16" height="16" fill="none">
              <path d="M5 3 L11 8 L5 13" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
