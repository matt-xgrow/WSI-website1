...
export function ShieldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 16 16" fill="none" width="16" height="16" {...props}>
      <path d="M8 2 L13 4 L13 8.5 C13 11 11 13 8 14 C5 13 3 11 3 8.5 L3 4 Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
      <path d="M5.5 8 L7.5 10 L10.5 6.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function CalendarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 16 16" fill="none" width="16" height="16" {...props}>
      ...
      <path d="M2.5 6.5 H13.5" stroke="currentColor" strokeWidth="1.4" />
      <path d="M5.5 2 V5 M10.5 2 V5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
