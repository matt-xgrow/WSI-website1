...
export const services = [
  ...
  {
    slug: "roof-cleaning-brisbane",
    name: "Roof Cleaning",
    eyebrow: "Specialized service",
    title: "Roof Cleaning Brisbane",
    ...
    tags: ["roof-cleaning", "brisbane"],
  },
  {
    slug: "driveway-cleaning-brisbane",
    name: "Driveway Cleaning",
    eyebrow: "Curb appeal boost",
    title: "Driveway Cleaning Brisbane",
    description: "High-pressure driveway cleaning to remove oil stains, tire marks, dirt, and mold from concrete, exposed aggregate, and pavers.",
    image: "/images/pressure-cleaning.jpg",
    ...
    tags: ["driveway-cleaning", "brisbane"],
  },
  {
    slug: "solar-panel-cleaning-brisbane",
    name: "Solar Panel Cleaning",
    eyebrow: "Efficiency boost",
    title: "Solar Panel Cleaning Brisbane",
    ...
    tags: ["solar-panel", "brisbane"],
  },
  {
    slug: "strata-cleaning-brisbane",
    name: "Strata Cleaning",
    eyebrow: "Body corporate",
    title: "Strata Exterior Cleaning Brisbane",
    ...
    tags: ["strata-cleaning", "brisbane"],
  },
  {
    slug: "commercial-building-washing-brisbane",
    name: "Commercial Building Washing",
    eyebrow: "Business presentation",
    title: "Commercial Building Washing Brisbane",
    ...
    proof: "After-hours availability, elevated work platform (EWP) licensing, and comprehensive safety protocols.",
    tags: ["commercial", "brisbane"],
  },
