...
export const SERVICE_CONTENT: Record<string, ServiceContent> = {
  ...
  "window-cleaning": {
    lead: "Window cleaning covers interior and exterior glass, frames, sills, screens and tracks for homes, offices, shopfronts and body corporate properties. WSI Cleaning operates across Brisbane, the Gold Coast and the Sunshine Coast on either one-off bookings or recurring schedules — fortnightly, monthly and quarterly are the most common. Coastal Gold Coast and Sunshine Coast homes typically need windows cleaned every 6–8 weeks because of salt-air haze; inland Brisbane homes can stretch to quarterly without losing clarity.",
    definition: {
    ...
    faqs: [
      ...
      { q: "How often should I have my windows cleaned?", a: "Inland Brisbane: quarterly is the most common cycle. Within 1 km of the coast (Gold Coast and Sunshine Coast): every 6–8 weeks because of salt haze. Commercial street-front shops: fortnightly or monthly to maintain presentation." },
